...
} from "../../../../auth/codex/codexAuthClient";
...
interface CodexRuntimeFactory {
  ...
  readonly generateBookmarkTitle: (
    input: GenerateBookmarkTitleInput,
...
export const createCodexRuntimeFactory = (
  ...
  return {
    ...
    generateBookmarkTitle: (input) =>
      responsesClient.generateBookmarkTitle(input),
    resumeSession: (input) =>
      Effect.succeed(
        new CodexSessionHandle({
          sessionId: input.sessionId,
...
export class CodexProviderAdapter implements ProviderAdapter {
  ...
  readonly generateBookmarkTitle = (input: GenerateBookmarkTitleInput) =>
    this.#runtimeFactory.generateBookmarkTitle(input);
